...
const ClubEmprendimiento = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
      ...
      {/* --- STATS / MANTRA --- */}
      {/* --- SOBRE NOSOTROS --- */}
      <div id="sobre-nosotros" className="py-16 bg-white overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="h-96 bg-gradient-to-br from-indigo-600 to-purple-700 p-8 flex flex-col justify-end">
                        <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                            ...
                            <div className="mt-4 flex items-center gap-3">
                                <div className="h-8 w-8 rounded-full bg-indigo-400 flex items-center justify-center text-xs font-bold text-white">US</div>
                                <span className="text-indigo-100 text-sm font-semibold">Directiva del Club</span>
                            </div>
                        </div>
                    </div>
                </div>
