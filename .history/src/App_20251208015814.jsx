...
import { Rocket, Users, Calendar, BookOpen, ArrowRight, Menu, X, CheckCircle, Mail, MapPin, Clock, Lightbulb, Target, ExternalLink } from 'lucide-react';
  ...
  const upcomingEvents = [
    {
      ...
      buttonText: "Apuntarme a la Inauguración" // Texto personalizado
    }
  ];
  ...
  const resources = [
    {
      ...
      comingSoon: true // <--- Esto activa el modo "Próximamente"
    },
    {
      title: "Comunidad",
      desc: "Acceso a nuestro canal de Telegram para que estés al tanto de la novedad emprendedora.",
      icon: <Users className="w-6 h-6 text-indigo-600" />,
      link: "https://t.me/+zMZUlhXhDqpiNzU0",
      comingSoon: false
    },
    {
      title: "Herramientas Dev", // Nuevo apartado
      desc: "Recursos técnicos, créditos cloud y software gratuito para desarrollar tu MVP.",
      icon: <Rocket className="w-6 h-6 text-indigo-600" />,
      comingSoon: true // <--- También en modo "Próximamente"
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50 font-sans text-gray-900">
          ...
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center gap-3">
                ...
                {/* CAMBIO 1: LOGO PRINCIPAL 
                   Reemplaza '/logo-club.png' con la ruta real de tu archivo.
                   'object-contain' asegura que no se deforme.
                */}
                <img 
                    src="/logo-club.png" 
                    alt="Logo Club Emprendimiento" 
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <a 
                ...
                className="bg-indigo-600 text-white px-5 py-2 rounded-full font-medium hover:bg-indigo-700 transition shadow-md"
              >
                Unirme al Club
              </a>
            </div>
      ...
      <div id="inicio" className="relative bg-white overflow-hidden">
        ...
        <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2 bg-indigo-50 flex items-center justify-center">
            {/* Placeholder visual - Aquí mantengo el cohete porque es decorativo, no es el logo */}
      ...
      {/* --- STATS / MANTRA --- */}
      {/* --- SOBRE NOSOTROS --- */}
      <div id="sobre-nosotros" className="py-24 bg-gray-50 overflow-hidden">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:grid lg:grid-cols-2 lg:gap-16 items-center">
            ...
            <div className="mb-12 lg:mb-0">
              ...
              <h3 className="mt-2 text-3xl leading-8 font-extrabold tracking-tight text-gray-900 sm:text-4xl">
                Más que un club, un ecosistema.
              </h3>
              <p className="mt-4 text-lg text-gray-500">
                Nacimos en los pasillos de la ETSII con una misión clara: romper la barrera entre la teoría universitaria y la realidad del mercado.
              </p>
              <p className="mt-4 text-lg text-gray-500">
                No importa si estudias Ingeniería Informática, Matemáticas o ADE. Si tienes curiosidad, ganas de construir y no te conformas con "lo de siempre", este es tu sitio.
              </p>
              ...
              <div className="mt-8">
                <div className="flex items-center">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg leading-6 font-medium text-gray-900">Misión Práctica</h4>
                    <p className="mt-2 text-base text-gray-500">
                      Olvídate de diapositivas infinitas. Aquí venimos a lanzar MVPs, validar hipótesis y aprender equivocándonos rápido.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-10 flex items-center">
                  ...
                  <div className="ml-4">
                    <h4 className="text-lg leading-6 font-medium text-gray-900">Talento Multidisciplinar</h4>
                    <p className="mt-2 text-base text-gray-500">
                      Conectamos perfiles técnicos con perfiles de negocio. Es la única forma de crear startups que funcionen de verdad.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="relative">
                ...
                <div className="relative rounded-2xl shadow-xl bg-gray-900 overflow-hidden border border-gray-200">
                    {/* Aquí puedes poner una foto real del equipo en el futuro */}
                    {/* <img src="/foto-equipo.jpg" alt="Equipo del club" className="w-full h-full object-cover" /> */}
                    
                    {/* Placeholder visual mientras no hay foto */}
                    <div className="h-96 bg-gradient-to-br from-indigo-600 to-purple-700 p-8 flex flex-col justify-end">
                        <div className="bg-white/10 backdrop-blur-md rounded-xl p-6 border border-white/20">
                            <p className="text-white font-medium text-lg italic">
                                "El emprendimiento no se estudia, se practica. Únete a la comunidad que está construyendo el futuro desde la universidad."
                            </p>
                        </div>
                    </div>
                </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            <div>
                <div className="flex items-center gap-3 mb-4">
                    {/* CAMBIO 2: LOGO FOOTER 
                       Misma lógica, aquí lo ponemos un poco más pequeño (h-8).
                    */}
                    <img 
                        src="/logo-club.png" 
                        alt="Logo Footer" 
                        className="h-8 w-auto object-contain brightness-0 invert" 
                        // Nota: 'brightness-0 invert' hace el logo blanco si es negro/color (útil para fondo oscuro)
                        // Si tu logo ya es blanco o tiene colores que se ven bien en oscuro, quita esas clases.
                    />
